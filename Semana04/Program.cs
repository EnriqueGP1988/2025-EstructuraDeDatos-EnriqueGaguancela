using System;  //Importa funcionalidades del sistema.
        ...
        while (!salir)  //Bucle principal del menú.
        {
            ...
            switch (opcion)
            {
                case "1":  //Agregar un nuevo paciente.
                    ...
                    Paciente nuevo = new Paciente(nombre, edad, dni);  //Crea un nuevo Paciente y lo agrega a la clínica.
                    clinica.AgregarPaciente(nuevo);
                    break;

                case "2":  //Asignar un turno a un paciente.
                    ...
                    Console.Write("Hora (0=08:00, 1=09:00, 2=10:00, 3=11:00, 4=12:00 5=13:00): ");
